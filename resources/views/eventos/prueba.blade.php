  ...
  <div class="col-md-4">
    ...
    {{csrf_field()}}
        <div class="form-group">
              <label class="col-md-4 control-label no-padding-right"> Nombre de evento</label>
            <div class="col-md-4">
              <input class="form-control" type="text" name = "nombre"required/>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-4 control-label no-padding-right"> Tipo de evento </label>
              <div class="col-md-4">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label no-padding-right"> Sub-Tipo de evento </label>
              <div class="col-md-4">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label no-padding-right"> Lugar de evento</label>
            <div class="col-md-4">
            <select class="" name="">
        ...
        <div class="form-group">
            <label class="col-md-4 control-label no-padding-right"> Fecha</label>
            <div class="col-md-4">
    <input type="date" name="fecha" value="" required>
        ...
        <div class="form-group">
            <label class="col-md-4 control-label no-padding-right">Cupos requeridos</label>
            <div class="col-md-4">
